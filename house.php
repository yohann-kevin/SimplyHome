...
<main id="house">
    ...
    <section id="presentationHouse" class="maxLength">
        ...
        <p>Que votre choix se porte sur une <span class="textBolder">maison traditionnelle</span> ou sur une <span class="textBolder">maison contemporaine</span>,
    ...
    <section id="allHouse" class="maxLength">
        ...
        <article class="articleHouse">
            ...
            <p class="houseArticleContent">Maison traditionnelle à étage de 104 m² habitables environ. Belle pièce de vie de 40m², 
        ...
        <article class="articleHouse">
            ...
            <p class="houseArticleContent">Maison contemporaine à étage de 106m² environ. Au RDC, belle pièce de vie de 44m²,cellier. 
